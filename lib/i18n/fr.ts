...
export const fr: Dictionary = {
  ...
  hero: {
    ...
    metrics: [
      { value: '12K', label: 'utilisateurs simultanés' },
  ...
  experience: {
    ...
    pageTitle: 'Parcours',
    roles: [
      { company: 'FinGenesis', title: 'Ingénieur Full-Stack (ScanAlpha)', period: 'Juil. 2025 — Présent', location: 'Remote', bullets: ['Livré Web + Android + iOS depuis une seule base de code Ionic + Angular, réduisant les coûts de maintenance vs. natif.', 'Conçu un backend temps réel Node.js + Express + WebSockets supportant 12 000 utilisateurs simultanés.', 'Porté la couverture de tests à 95 % (Vitest + Playwright E2E) dans GitLab CI/CD, réduisant la QA manuelle de 50 %.', 'Publié sur App Store & Google Play sans faille de sécurité critique ; Auth0 SSO + Sentry.'], tech: ['Ionic', 'Angular', 'TypeScript', 'Node.js', 'WebSockets', 'Playwright', 'GitLab CI/CD', 'Auth0', 'Sentry'], link: 'https://scanalpha.ai/' },
